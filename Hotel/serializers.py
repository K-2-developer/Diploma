...
class HotelSerializer(serializers.ModelSerializer):
    '''Serializer for the Hotel model which converts data into JSON format'''
    class Meta:
        model = Hotel
...
class RoomSerializer(serializers.ModelSerializer):
    '''Serializer for the Room model which converts data into JSON format'''
    class Meta:
        model = Room
        fields = ('room_id', 'hotel_id', 'type', 'room_price', 'available')

class BookingSerializer(serializers.ModelSerializer):
    '''Serializer for the Booking model which converts data into JSON format'''
    class Meta:
        model = Booking
...
class HotelPopularitySerializer(serializers.Serializer):
    '''Serializer not based on the model.Convert aggregated data into JSON format '''
...
class AdminStatisticSerializer(serializers.Serializer):
    '''Serializer for aggregated admin statistics'''
